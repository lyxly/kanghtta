...
Version:	2010.3.6AB.5
Release:	1%{?dist}
License:	GPLv2+
Group:		System Environment/Base
Source0:	http://pagesperso-orange.fr/b.andre/ntfs-3g-%{version}.tgz
Source1:	20-ntfs-config-write-policy.fdi
Patch0:		ntfs-3g-1.2216-nomtab.patch
URL:		http://pagesperso-orange.fr/b.andre
...
rm -rf $RPM_BUILD_ROOT/sbin/mount.lowntfs-3g
cp -a $RPM_BUILD_ROOT/bin/ntfs-3g $RPM_BUILD_ROOT/sbin/mount.ntfs-3g
cp -a $RPM_BUILD_ROOT/bin/lowntfs-3g $RPM_BUILD_ROOT/sbin/mount.lowntfs-3g
...
ln -s /bin/lowntfs-3g lowntfs-3g
...
%changelog
* Fri Apr 16 2010 Jean-Pierre Andre 2010.3.6AB.5
